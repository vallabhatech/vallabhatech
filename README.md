...
|---------|------------|---------|
| **CareSync** | Next.js, Python, Gemini API, MongoDB | 🤖 AI mental wellness chatbot for Gen Z serving **200+ users** |
| **FoodAid** | MERN, Socket.IO, Mapbox API | 🍲 Real-time food donation platform with **40% faster response time** |
| **V.E.R.I.T.A.S** | Flutter, Riverpod, REST APIs | 🔍 AI-generated media detection platform combating misinformation |
...
- 🤖 **Google Agentathon** participant  
- 🌟 **Top 50 Contributor** in IEEE Summer of Code 2025  
- 🎯 **Finalist** at Technovista Hackathon  
